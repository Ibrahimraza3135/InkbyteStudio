...
export default function Header({ currentPage, onNavigate }: HeaderProps) {
  ...
  const pageMeta = {
    home: {
      title: 'InkbyteStudio – Professional Wikipedia Page Services',
    ...
    why: {
      title: 'Why Hire Wikipedia Experts – InkbyteStudio',
  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <link rel="canonical" href={`https://InkbyteStudio.net/${currentPage}`} />
        ...
        <meta property="og:url" content={`https://InkbyteStudio.net/${currentPage}`} />
      </Helmet>
