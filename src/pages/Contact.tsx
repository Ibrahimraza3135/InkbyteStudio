...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-[#FAF9F6] to-amber-50/20 pt-24 pb-12">
      {/* ================= SEO ================= */}
      <Helmet>
        <title>Contact Inkbyte Studio | Wikipedia Page Consultation</title>
        <meta
          name="description"
          content="Get in touch with Inkbyte Studio for professional Wikipedia page creation, editing, and notability assessment services."
        />
        <link rel="canonical" href="https://InkbyteStudio.net/contact" />

        {/* Open Graph */}
        <meta property="og:title" content="Contact Inkbyte Studio" />
        <meta
