...
export default function Home({ onNavigate }: HomeProps) {
  ...
  const testimonials = [
    {
      ...
      content:
        'InkbyteStudio helped us establish credibility in our industry. Their expertise with Wikipedia guidelines was invaluable.',
      rating: 5,
    },
    {
  ...
  return (
    <div className="min-h-screen bg-ash-white">
      {/* ================= SEO ================= */}
      <Helmet>
        <title>Professional Wikipedia Page Creation Services | Inkbyte Studio</title>
        <meta
          name="description"
          content="Inkbyte Studio offers professional Wikipedia page creation, editing, and notability assessment services that fully comply with Wikipedia guidelines."
        />
