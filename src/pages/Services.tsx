...
export default function Services({ onNavigate }: ServicesProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-[#FAF9F6] to-amber-50/20 pt-24 pb-12">
      {/* ================= SEO ================= */}
      <Helmet>
        <title>Services | Inkbyte Studio Wikipedia Services</title>
        <meta
          name="description"
          content="Explore Inkbyte Studio's professional Wikipedia services: Notability Assessment, Page Creation, Page Rewrite, and Monitoring & Maintenance."
        />
        <link rel="canonical" href="https://InkbyteStudio.net/services" />

        {/* Open Graph */}
        <meta property="og:title" content="Services | Inkbyte Studio" />
        <meta
