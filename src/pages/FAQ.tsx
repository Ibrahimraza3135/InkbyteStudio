...
export default function FAQ({ onNavigate }: FAQProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-[#FAF9F6] to-amber-50/20 pt-24 pb-12">
      {/* ================= SEO ================= */}
      <Helmet>
        <title>FAQ | Inkbyte Studio Wikipedia Services</title>
        <meta
          name="description"
          content="Frequently Asked Questions about Wikipedia page creation, editing, and notability assessment by Inkbyte Studio."
        />
        <link rel="canonical" href="https://InkbyteStudio.net/faq" />

        {/* Open Graph */}
        <meta property="og:title" content="FAQ | Inkbyte Studio" />
        <meta
