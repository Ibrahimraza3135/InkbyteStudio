...
export default function About({ onNavigate }: AboutProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-[#FAF9F6] to-amber-50/20 pt-24 pb-12">
      {/* ================= SEO ================= */}
      <Helmet>
        <title>About Inkbyte Studio | Wikipedia Page Creation Experts</title>
        <meta
          name="description"
          content="Learn about Inkbyte Studio's mission, team, and values. We are professional Wikipedia writers and editors helping brands build digital credibility."
        />
        <link rel="canonical" href="https://InkbyteStudio.net/about" />

        {/* Open Graph */}
        <meta property="og:title" content="About Inkbyte Studio | Wikipedia Page Creation Experts" />
        <meta
          property="og:description"
          content="Get to know the team behind Inkbyte Studio and our commitment to Wikipedia policy compliance."
        />
        <meta property="og:url" content="https://InkbyteStudio.net/about" />
